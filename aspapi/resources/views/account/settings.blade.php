...
<div style="max-width:520px;">
    ...
    <div style="background:#fff;border:1px solid #D6E8F7;border-radius:6px;padding:1.5rem;margin-bottom:1.25rem;">
        ...
        <div style="display:flex;flex-direction:column;gap:0.75rem;">
            ...
            <div>
                <p style="font-size:0.7rem;color:#B0CCDF;text-transform:uppercase;letter-spacing:0.08em;">Email</p>
                <p style="font-size:0.9rem;color:#1A2A3A;margin-top:0.2rem;">{{ $user->email }}</p>
            </div>
            <div>
