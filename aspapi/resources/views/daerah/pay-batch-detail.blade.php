...
<div class="grid gap-5" style="grid-template-columns:1fr 300px;align-items:start;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid #EEF4FB;" onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background='#fff'">
                            <td style="padding:0.75rem 1rem;">
                                <p style="font-size:0.85rem;font-weight:600;color:#1A2A3A;margin:0;">{{ $payment->member->full_name_with_title ?? '—' }}</p>
    ...
    <div style="background:#fff;border:1px solid #D6E8F7;border-radius:6px;padding:1.25rem;">
        ...
        @php
            ...
            $stLabel = $st === 'verified' ? '✓ Terverifikasi' : ($st === 'rejected' ? '✗ Ditolak' : '⏳ Menunggu Verifikasi');
        @endphp
