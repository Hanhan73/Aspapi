...
<header class="bg-white border-b-2 border-primary-400 shadow-navbar sticky top-0 z-50" x-data="{ mobileOpen: false }">
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden lg:flex items-center gap-6">
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div class="border-t border-neutral-100 my-1"></div>
                        <a href="{{ route('regions.index') }}" class="flex items-center px-4 py-2.5 text-xs text-neutral-600 hover:bg-primary-100 hover:text-primary transition-colors duration-150
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-150"
                        ...
                        class="absolute top-full left-0 mt-0.5 w-52 bg-white border border-neutral-200 rounded-md shadow-card-hover py-1.5 z-50"
                        style="display: none;">
                        <a href="{{ route('news.index') }}" class="flex items-center px-4 py-2.5 text-xs text-neutral-600 hover:bg-primary-100 hover:text-primary transition-colors duration-150
                                   {{ request()->routeIs('news.*') ? 'text-primary font-semibold' : '' }}">
                            Berita
                        </a>
                        <a href="{{ route('blog.index') }}" class="flex items-center px-4 py-2.5 text-xs text-neutral-600 hover:bg-primary-100 hover:text-primary transition-colors duration-150
                                   {{ request()->routeIs('blog.*') ? 'text-primary font-semibold' : '' }}">
                            Blog
                        </a>
                        <a href="{{ route('documents.index') }}" class="flex items-center px-4 py-2.5 text-xs text-neutral-600 hover:bg-primary-100 hover:text-primary transition-colors duration-150
            ...
            <a href="{{ route('partners.index') }}"
                class="nav-link text-sm {{ request()->routeIs('partners.*') ? 'nav-link-active' : '' }}">
                Mitra
            </a>
    ...
    <div x-show="mobileOpen" x-transition:enter="transition ease-out duration-200"
        ...
        class="lg:hidden bg-white border-t border-neutral-200 overflow-y-auto max-h-[80vh]" style="display: none;">
        ...
        <nav class="px-4 py-3 flex flex-col divide-y divide-neutral-100">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="pb-2 pl-3 flex flex-col gap-0.5" style="display:none;">
                    <a href="{{ route('profile.vision-mission') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Visi dan Misi</a>
                    <a href="{{ route('profile.history') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Sejarah Singkat</a>
                    <a href="{{ route('profile.initiators') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Inisiator</a>
                    <a href="{{ route('profile.congress') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Kongres</a>
                    <div class="border-t border-neutral-100 my-1"></div>
                    <a href="{{ route('profile.advisors') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Dewan Penasihat</a>
                    <a href="{{ route('profile.experts') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Dewan Pakar</a>
                    <a href="{{ route('profile.board') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Pengurus</a>
                    <div class="border-t border-neutral-100 my-1"></div>
                    <a href="{{ route('regions.index') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">ASPAPI Daerah</a>
                </div>
            </div>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="pb-2 pl-3 flex flex-col gap-0.5" style="display:none;">
                    <a href="{{ route('members.types') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Jenis &amp; Syarat Anggota</a>
                    <a href="{{ route('members.register') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Pendaftaran Anggota</a>
                </div>
            </div>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="pb-2 pl-3 flex flex-col gap-0.5" style="display:none;">
                    <a href="{{ route('news.index') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Berita</a>
                    <a href="{{ route('blog.index') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Blog</a>
                    <a href="{{ route('documents.index') }}"
                        class="py-2 text-xs text-neutral-500 hover:text-primary">Download</a>
                </div>
            </div>
            ...
            <div class="pt-4 pb-2 flex flex-col gap-3">
                <a href="{{ route('members.register') }}" class="btn btn-primary w-full text-center">
                    Daftar Anggota
                </a>
