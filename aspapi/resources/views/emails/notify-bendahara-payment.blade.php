...
<body>
    <div class="container">
        <div class="header">
            <h1>🔔 Bukti Pembayaran Masuk</h1>
            <p>Notifikasi sistem — ASPAPI</p>
        </div>
        <div class="body">
            <span class="badge">Pembayaran Mandiri</span>
            <p>Ada anggota yang mengunggah bukti pembayaran dan menunggu verifikasi.</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    <span class="info-label">Waktu Upload</span>
                    <span class="info-value">{{ $submittedAt }}</span>
                </div>
            </div>

            <div class="alert">
                <strong>📋 Perlu Tindakan:</strong> Buka portal bendahara, periksa bukti transfer, lalu verifikasi atau tolak pembayaran ini.
            </div>

            <div style="text-align:center;margin-top:1.5rem;">
                <a href="{{ $bendaharaUrl }}" class="btn">Verifikasi Sekarang</a>
            </div>
        </div>
        <div class="footer">
