...
<div style="background:#FEF8EC;border-left:4px solid #E8B84B;border-radius:8px;padding:1.5rem;margin-bottom:1.5rem;">
    ...
    <ul style="font-size:0.825rem;color:#8B6914;margin-top:0.5rem;padding-left:1.25rem;">
        ...
        <li>{{ $member?->registration_type === 'baru' ? 'Uang pangkal sudah diverifikasi Bendahara' : 'Iuran tahunan sudah diverifikasi Bendahara' }}
            ✓</li>
    </ul>
</div>
@endif
...
{{-- Preferensi Gelar --}}
<div
    style="background:#fff;border:1px solid #D6E8F7;border-radius:8px;padding:1rem 1.25rem;margin-bottom:1.25rem;display:flex;align-items:center;gap:1rem;flex-wrap:wrap;">
    <span
        style="font-size:0.75rem;font-weight:700;color:#4A6580;letter-spacing:0.05em;text-transform:uppercase;">Tampilan
        Nama di Kartu:</span>
    <form method="POST" action="{{ route('member.card.preference') }}"
...
<div style="background:#fff;border:1px solid #D6E8F7;border-radius:8px;padding:2rem;text-align:center;">
    <svg style="width:48px;height:48px;color:#2A7FC1;margin:0 auto 1rem;" fill="none" stroke="currentColor"
        viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0" />
    </svg>
    <h3 style="font-family:'DM Serif Display',serif;font-size:1.25rem;color:#1A2A3A;margin-bottom:0.5rem;">Siap Generate
        Kartu Anggota!</h3>
    <p style="font-size:0.875rem;color:#4A6580;margin-bottom:1.5rem;">Semua syarat terpenuhi. Klik tombol di bawah untuk
        membuat nomor anggota dan kartu Anda.</p>
