...
<div style="background:#fff;border:1px solid #D6E8F7;border-radius:8px;padding:1.5rem;margin-bottom:1.5rem;">
    ...
    <form method="POST" action="{{ route('member.payment.store') }}" enctype="multipart/form-data"
        ...
        <div x-show="selectedType"
            ...
            <div>
                <p style="font-size:0.7rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#4A6580;">Total yang harus ditransfer</p>
                <p x-text="getLabel()" style="font-size:0.8rem;color:#4A6580;margin-top:0.125rem;"></p>
            </div>
            <p x-text="getAmount()" style="font-size:1.5rem;font-weight:800;color:#1A5F9A;font-family:'DM Serif Display',serif;"></p>
        </div>
        ...
        <table style="width:100%;border-collapse:collapse;">
            <thead>
                <tr style="background:#EEF4FB;">
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Jenis</th>
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Jumlah</th>
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Metode</th>
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Status</th>
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Tanggal</th>
                    <th style="padding:0.625rem 1rem;text-align:left;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#2A7FC1;white-space:nowrap;">Bukti</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="border-bottom:1px solid #F8FAFC;">
                    ...
                    <td style="padding:0.75rem 1rem;">
                        ...
                        @endphp
                        <span style="font-size:0.65rem;font-weight:700;padding:0.2rem 0.5rem;border-radius:2px;{{ $statusStyle }}">
                            {{ $statusLabel }}
                        </span>
                    </td>
                    <td style="padding:0.75rem 1rem;font-size:0.8rem;color:#4A6580;white-space:nowrap;">{{ $pay->created_at->format('d M Y') }}</td>
                    <td style="padding:0.75rem 1rem;">
                        @if ($pay->receipt_path)
