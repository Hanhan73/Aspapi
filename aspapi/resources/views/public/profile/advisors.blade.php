...
<div
    style="background:linear-gradient(135deg,#111E2A,#1A5F9A,#2A7FC1);position:relative;padding:3rem 1.5rem 2.5rem;overflow:hidden;">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <p
            style="font-size:0.65rem;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#E8B84B;margin-bottom:0.5rem;">
            Profil Organisasi</p>
        <h1
            style="font-family:'DM Serif Display',serif;color:#fff;font-size:clamp(1.75rem,4vw,2.75rem);line-height:1.2;">
            Dewan Penasihat ASPAPI</h1>
        <p style="color:#A8D4F5;font-size:0.875rem;margin-top:0.75rem;max-width:600px;line-height:1.7;">Periode
            2022–2026</p>
    </div>
</div>
...
<section class="py-14 bg-white">
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:1rem;">
            @foreach ([
            ['label' => 'Fungsi', 'text' => 'Memberikan masukan kepada Pengurus Pusat dalam mengambil keputusan
            organisasi.'],
...
<section class="py-14" style="background:#F8FAFC;">
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:1.5rem;">
            ...
            @endphp
            <div
                style="background:#fff;border:1px solid #D6E8F7;border-radius:8px;overflow:hidden;border-top:3px solid #2A7FC1;text-align:center;">
                <div
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;">
                        <div
                            style="width:80px;height:80px;border-radius:50%;background:#2A7FC1;display:flex;align-items:center;justify-content:center;">
                            <span
                                style="font-family:'DM Serif Display',serif;font-size:2rem;color:#fff;">{{ $initial }}</span>
                        </div>
                        <span
                            style="font-size:0.6rem;color:#B0CCDF;letter-spacing:0.08em;text-transform:uppercase;">Foto
                            belum tersedia</span>
                    </div>
                    @endif
                </div>
                <div style="padding:1.25rem;">
                    <div style="width:32px;height:3px;background:#E8B84B;border-radius:2px;margin:0 auto 0.75rem;">
                    </div>
                    ...
                    @if ($person->position)
                    <span
                        style="display:inline-block;margin-top:0.625rem;font-size:0.65rem;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;padding:0.25rem 0.625rem;border-radius:2px;background:#EEF4FB;color:#2A7FC1;">
                        {{ $person->position }}
                    </span>
                    @endif
                </div>
