...
<section class="relative overflow-hidden bg-gradient-to-br from-navy-dark via-primary-600 to-primary py-16">
    ...
    <div class="relative max-w-7xl mx-auto px-6">
        ...
        <p class="text-primary-200 text-sm leading-relaxed max-w-xl">
            Ikuti perkembangan terbaru kegiatan, program, dan pencapaian ASPAPI
...
<section class="py-16 bg-neutral-50">
    <div class="max-w-7xl mx-auto px-6">
        ...
        @else
            ...
            {{-- Featured (first item, full-width) jika halaman 1 & tidak ada filter --}}
            @if($news->currentPage() === 1 && !request()->hasAny(['cari', 'kategori']) && $news->count() > 0)
                ...
                {{-- Grid berita lainnya (skip item pertama) --}}
            ...
            @else
                {{-- Normal grid (halaman 2+ atau ada filter) --}}
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
