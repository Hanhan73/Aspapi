...
══════════════════════════════════════════════ --}}
<section
    class="relative overflow-hidden bg-gradient-to-br from-navy-dark via-primary-600 to-primary min-h-[580px] flex items-center">
        ...
        <div class="max-w-2xl">
            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <a href="{{ route('profile.vision-mission') }}"
                    class="btn btn-lg border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50">
                    Tentang ASPAPI
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
                ...
                <p class="text-neutral-500 leading-relaxed mb-4">
                    <strong class="text-navy">ASPAPI</strong> — Asosiasi Sarjana dan Praktisi Administrasi Perkantoran
                    Indonesia —
                ...
                <p class="text-neutral-500 leading-relaxed mb-4">
                    Gagasan ini bermula pada <strong class="text-navy">27 Februari 2010</strong> di Universitas Sebelas
                    Maret (UNS),
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                'letter' => 'C',
                'title' => 'Competent',
                'desc' => 'Mendorong setiap anggota untuk memiliki kompetensi tinggi di bidang administrasi dan
                ...
                'letter' => 'C',
                'title' => 'Collaborative',
                'desc' => 'Membangun sinergi antar anggota, institusi, dan pemangku kepentingan untuk kemajuan
                bersama.',
                ],
                ];
                @endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="card card-top-blue card-hover p-7">
                ...
                <p class="text-sm text-neutral-500 leading-relaxed">
                    ASPAPI membuka kesempatan kepada anggota untuk mempublikasikan hasil penelitian melalui jurnal
                    ilmiah berkala yang diterbitkan oleh ASPAPI. Jurnal ini merupakan wadah untuk memfasilitasi
                    diseminasi penelitian berkualitas tinggi dan mendorong pertukaran gagasan di antar anggota ASPAPI.
                </p>
            </div>
            ...
            <div class="card card-top-blue card-hover p-7">
                ...
                <p class="text-sm text-neutral-500 leading-relaxed">
                    ASPAPI berkomitmen untuk mendukung pengembangan kompetensi anggota dalam bidang
                    administrasi/manajemen perkantoran, melalui pelatihan dan seminar. Kegiatan ini diselenggarakan
                    secara berkala, baik oleh ASPAPI Pusat maupun oleh ASPAPI Daerah.
                </p>
            </div>
            ...
            <div class="card card-top-red card-hover p-7">
                ...
                <p class="text-sm text-neutral-500 leading-relaxed">
                    ASPAPI membuka kesempatan kepada Sekolah Menengah Kejuruan (SMK) untuk bermitra dalam
                    menyelenggarakan UKK Administrasi Perkantoran bagi siswa. Dengan mengadakan UKK secara teratur,
                    ASPAPI berperan aktif dalam mendukung peningkatan standar keahlian siswa SMK serta memastikan
            ...
            <div class="card card-top-red card-hover p-7">
                ...
                <p class="text-sm text-neutral-500 leading-relaxed">
                    ASPAPI menyelenggarakan USK untuk mengukur dan menilai tingkat keahlian individu dalam bidang
                    Administrasi Perkantoran. Pelaksanaan USK dilakukan oleh Lembaga Sertifikasi Profesi (LSP-KAP) yang
                    merupakan bagian integral dari ASPAPI dan telah mendapatkan lisensi dari BNSP.
                </p>
            </div>
...
<section class="py-12 bg-neutral-50">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex items-end justify-between mb-8">
            <div>
                <p class="section-label">Terkini</p>
                <h2 class="section-title mt-1">Blog Terbaru</h2>
                <div class="section-divider"></div>
            </div>
...
══════════════════════════════════════════════ --}}
<section class="relative overflow-hidden bg-gradient-to-r from-primary-600 to-navy py-12">
