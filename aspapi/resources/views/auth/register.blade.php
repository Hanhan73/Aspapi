...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:2rem;">
    <div style="width:100%;max-width:520px;">
        ...
        <div style="text-align:center;margin-bottom:2rem;">
            ...
            <h1 style="font-family:'DM Serif Display',serif;font-size:1.75rem;color:#1A2A3A;">Daftar Anggota Baru</h1>
        ...
        <div style="background:#EEF4FB;border-left:4px solid #2A7FC1;border-radius:4px;padding:1rem 1.25rem;margin-bottom:1.5rem;font-size:0.825rem;color:#1A5F9A;">
            Setelah mendaftar, Anda akan menerima email verifikasi. Setelah email diverifikasi, lengkapi biodata dan tunggu verifikasi dari Admin.
        </div>
        ...
        @if (session('success'))
        <div style="background:#F0FFF4;border-left:4px solid #276749;border-radius:4px;padding:1rem;margin-bottom:1.5rem;">
        ...
        <div style="text-align:center;margin-top:1.5rem;font-size:0.825rem;color:#4A6580;">
            ...
            &nbsp;·&nbsp;
            Anggota lama? <a href="{{ route('register.old') }}" style="color:#C0392B;font-weight:700;">Daftar di sini</a>
        </div>
