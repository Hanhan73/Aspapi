    ...
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:2rem;">
        <div style="width:100%;max-width:520px;">
            ...
            <div style="text-align:center;margin-bottom:2rem;">
                ...
                <h1 style="font-family:'DM Serif Display',serif;font-size:1.75rem;color:#1A2A3A;">Daftar Anggota Lama
                </h1>
                <p style="font-size:0.875rem;color:#4A6580;margin-top:0.375rem;">Untuk anggota yang sudah terdaftar
                    sebelumnya</p>
            </div>

            <div
                style="background:#FEF8EC;border-left:4px solid #E8B84B;border-radius:4px;padding:1rem 1.25rem;margin-bottom:1.5rem;font-size:0.825rem;color:#8B6914;">
                Daftar di sini jika Anda sudah pernah menjadi anggota ASPAPI sebelumnya. Admin akan memverifikasi status
                keanggotaan lama Anda.
            </div>
            ...
            <form method="POST" action="{{ route('register.old.store') }}"
                ...
                <div style="margin-bottom:1.25rem;">
                    ...
                    <input type="number" name="claimed_join_year" value="{{ old('claimed_join_year') }}" min="2010"
                        max="{{ now()->year }}" placeholder="contoh: 2015" required
                        style="width:100%;padding:0.75rem 1rem;border:1.5px solid #D6E8F7;border-radius:4px;font-size:0.875rem;color:#1A2A3A;outline:none;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#2A7FC1'" onblur="this.style.borderColor='#D6E8F7'" />
                    <p style="font-size:0.72rem;color:#B0CCDF;margin-top:0.375rem;">Tahun ini akan diverifikasi oleh
                        Admin ASPAPI.</p>
                </div>
            ...
            <div style="text-align:center;margin-top:1.5rem;font-size:0.825rem;color:#4A6580;">
                ...
                &nbsp;·&nbsp;
                Anggota baru? <a href="{{ route('register') }}" style="color:#2A7FC1;font-weight:700;">Daftar di
                    sini</a>
            </div>
        </div>
    </div>
