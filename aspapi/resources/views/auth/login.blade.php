...
<body style="background:#F8FAFC;font-family:'DM Sans',sans-serif;">
    <div style="min-height:100vh;display:flex;">
        ...
        {{-- Kiri: Branding --}}
        <div style="display:none;width:42%;background:linear-gradient(135deg,#111E2A,#1A5F9A,#2A7FC1);position:relative;overflow:hidden;"
            id="branding-panel">
            <div
                style="position:absolute;inset-x:0;top:0;height:4px;background:linear-gradient(90deg,#C0392B,#E8B84B);">
            </div>
            <div
                style="position:absolute;right:-80px;top:-80px;width:300px;height:300px;border-radius:50%;background:rgba(255,255,255,0.04);">
            </div>
            <div
                style="position:absolute;left:40px;bottom:120px;width:120px;height:120px;border-radius:50%;background:rgba(232,184,75,0.08);">
            </div>
            <div
                style="position:relative;height:100%;display:flex;flex-direction:column;justify-content:center;padding:3rem;">
                <img src="{{ asset('images/logo-aspapi.png') }}"
                    style="height:104px;width:auto;object-fit:contain;margin-bottom:2rem;"
                    onerror="this.style.display='none'" />
                <h1
                    style="font-family:'DM Serif Display',serif;color:#fff;font-size:2rem;line-height:1.2;margin-bottom:1rem;">
        ...
        <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:2rem;">
            <div style="width:100%;max-width:400px;">
                ...
                <div style="text-align:center;margin-bottom:2rem;" class="lg-hidden">
                    <img src="{{ asset('images/logo-aspapi.png') }}" style="height:48px;margin:0 auto 0.75rem;"
                        onerror="this.style.display='none'" />
                </div>

                <p
                    style="font-size:0.65rem;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#C0392B;margin-bottom:0.5rem;">
                    Portal ASPAPI</p>
                ...
                @if (session('success'))
                <div
                    style="background:#F0FFF4;border-left:4px solid #276749;border-radius:4px;padding:0.875rem 1rem;margin-bottom:1.5rem;">
                ...
                <form method="POST" action="{{ route('login.member') }}">
                    ...
                    <div style="margin-bottom:1.75rem;">
                        <label
                            style="display:block;font-size:0.7rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#4A6580;margin-bottom:0.5rem;">Password</label>
                        <div style="position:relative;">
                            ...
                            <button type="button" onclick="togglePw()"
                                ...
                                <svg id="eye" style="width:18px;height:18px;" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
